...
### This is significantly better than using syn.protect_gui (failed 8 checks I made, while this script bypasses all of them (more info can be found [here](/CHECKSINFO.md)).
